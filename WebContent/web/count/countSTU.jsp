...
<script type="text/javascript">
	...
	table.render({
		elem:"#demo",
		url:"/student/count?action=list",//数据库
		height:"full-100",
		width:"1030",
		toolbar:"#toolbarDemo",
		...
		cols:[[
			...
			{title:"班级序号", field:"classStudent"},//与list（model）中的值对应
			{title:"学生学号", field:"codeStudent"},
			{title:"学生姓名", field:"nameStudent"},
			{title:"学生性别", field:"sexStudent"},
			{title:"班级人数", field:"countPeople"},
			{title:"男生人数", field:"countMan"},
			{title:"女生人数", field:"countWoman"},
		]]
	});

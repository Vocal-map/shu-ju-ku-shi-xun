      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child" >
            <dd><a href="javascript:openUrl('/student/web/student/list.jsp');">学生信息维护</a></dd>
            <dd><a href="javascript:openUrl('/student/web/classes/list.jsp');">班级信息维护</a></dd>
            <dd><a href="javascript:openUrl('/student/web/course/list.jsp');">课程信息维护</a></dd>
            <dd><a href="javascript:openUrl('/student/web/dormitory/list.jsp');">宿舍信息维护</a></dd>
            <dd><a href="javascript:openUrl('/student/web/result/list.jsp');">成绩信息维护</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
          <a href="javascript:;">控制台</a>
          <dl class="layui-nav-child">
            <dd><a href="javascript:openUrl('/student/web/admin/login2.jsp');">账号管理</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">

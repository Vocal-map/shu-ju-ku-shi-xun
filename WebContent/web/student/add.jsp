 ...
 <form class="layui-form" lay-filter="formA">
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="codeStudent" required  lay-verify="required" 
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
<!-- 	<input type="text" name="sexStudent" required lay-verify="required" 
      placeholder="请输入学生性别" autocomplete="off" class="layui-input"> -->
	        ...
	        success:function(data){//请求成功返回数据时候执行的方法
	            //data请求返回的数据{code:1}
	              ...
	              if(code==1){
	            	  ...
	            	  layer.msg("添加失败, 学号已存在")
	              }else if(code==3){
	            	  layer.msg("添加失败, 班级不存在")
	              }else if(code==4){
	            	  layer.msg("添加失败, 宿舍不存在")
	              }else{
	            	  layui.msg("添加失败")
	              }
	        }
